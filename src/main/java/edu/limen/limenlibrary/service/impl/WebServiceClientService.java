...
import edu.limen.limenlibrary.http.request.json.BaseRequestJson;
import edu.limen.limenlibrary.service.IWebServiceClientService;
import edu.limen.limenlibrary.utility.FileSystemUtils;
...
public class WebServiceClientService extends BaseService implements IWebServiceClientService {
	...
	public HttpResponse requestByString(HttpClient httpclient, String json) {
		...
		HttpHost proxy = new HttpHost("10.11.18.120", 8080);
